  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <div className="guide" style={{ flex: 1 }}>
        ...
        <div className="guide__section">
          <h2 className="guide__section-title">5. Acceptable Use</h2>
          <div className="guide__body">
        ...
        <div className="guide__section">
          <h2 className="guide__section-title">6. Limitation of Liability</h2>
          <div className="guide__body">
        ...
        <div className="guide__section">
          <h2 className="guide__section-title">7. General</h2>
          <div className="guide__body">
