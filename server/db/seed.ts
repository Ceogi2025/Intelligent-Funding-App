...
type ProductRow = {
  ...
  bureau_pulled: 'Experian' | 'Equifax' | 'TransUnion' | 'All 3' | 'Varies by state' | 'None' | 'Not Verified'
  reports_to: string
...
const allInstitutions: InstitutionRow[] = [
...

  {
    ...
    path: 'Capital Access',
    products: [
      { name: 'Citi Double Cash Card', type: 'Unsecured Card', bureau_pulled: 'Varies by state', reports_to: 'All 3', inquiry_reuse_eligible: 'Yes', preapproval_available: 'Yes', minimum_credit_score: 670, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: '2% cash back (1% earn + 1% pay). Preapproval available. Inquiry reuse within 30 days for multiple Citi products. Bureau VARIES BY STATE — this is the classic case. 62 community datapoints (CreditBoards, Sep 2026): Experian 37, Equifax 19, TransUnion 6. But weighting recent reports (2022+) flips it: Equifax 8, Experian 5, TransUnion 0. Experian leans CA and TX; Equifax leans GA and MI. CALL AND ASK which bureau they pull before you apply, and plan the lane around their answer. VELOCITY RULE (Citi speed limit): only 1 card application per 8 days, max 2 cards per rolling 65 days. With Citi it is timing, not count — space the applications.', verified_date: '2026-09-01'},
      { name: 'Citi Custom Cash Card', type: 'Unsecured Card', bureau_pulled: 'Varies by state', reports_to: 'All 3', inquiry_reuse_eligible: 'Yes', preapproval_available: 'Yes', minimum_credit_score: 670, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: '5% on top spend category. Stack with Double Cash on the same inquiry for a dual-Citi setup. Bureau VARIES BY STATE — this is the classic case. 62 community datapoints (CreditBoards, Sep 2026): Experian 37, Equifax 19, TransUnion 6. But weighting recent reports (2022+) flips it: Equifax 8, Experian 5, TransUnion 0. Experian leans CA and TX; Equifax leans GA and MI. CALL AND ASK which bureau they pull before you apply, and plan the lane around their answer. VELOCITY RULE (Citi speed limit): only 1 card application per 8 days, max 2 cards per rolling 65 days. With Citi it is timing, not count — space the applications.', verified_date: '2026-09-01'},
    ],
  },
...

  {
    ...
    products: [
      { name: 'Credit One Platinum Visa for Rebuilding Credit', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: '$75 first year, then $99/yr (billed $8.25/mo)', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau REPORTED Experian: 6 of 8 community datapoints Experian, 2 TransUnion, most recent 2023. Leans Experian but not unanimous, so call and confirm. Bureau not yet verified. Targets rebuilding credit. 29.74% variable APR. Official soft-pull prequalification, no credit impact.' },
      { name: 'Credit One Platinum Visa', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: '$39', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau REPORTED Experian: 6 of 8 community datapoints Experian, 2 TransUnion, most recent 2023. Leans Experian but not unanimous, so call and confirm. Bureau not yet verified. 29.74% variable APR. Official soft-pull prequalification.' },
      { name: 'Credit One Premier American Express Card', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau REPORTED Experian: 6 of 8 community datapoints Experian, 2 TransUnion, most recent 2023. Leans Experian but not unanimous, so call and confirm. Bureau not yet verified. Unlimited 1% cash back, no annual fee — a rare $0-AF option in the rebuilder-card space, on the Amex network. Official soft-pull prequalification.' },
      ...
      { name: 'Credit One Wander American Express Card', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'Not publicly displayed', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau REPORTED Experian: 6 of 8 community datapoints Experian, 2 TransUnion, most recent 2023. Leans Experian but not unanimous, so call and confirm. Bureau not yet verified. Travel card — 10% back on hotels/car rentals via Credit One\'s travel partner, 5% on a secondary tier. Official soft-pull prequalification.' },
    ],
  },

  {
    ...
    verified_date: '2026-07-06',
    products: [
      { name: 'Huntington Cashback Credit Card', type: 'Unsecured Card', bureau_pulled: 'Equifax', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau REPORTED Equifax: 4 of 4 community datapoints unanimous (PA, MI, KY) but all are 2018 or older, so treat this as a lead rather than settled. Call and confirm. Bureau not a single answer — sources conflict between TransUnion and Equifax (one insider claim of "Equifax and Transunion primarily", another names Equifax for the Voice card specifically). Unlimited 1.5% cash back, no foreign transaction fee, 15.49%-27.49% APR.' },
      { name: 'Huntington Voice Rewards Credit Card (3X)', type: 'Unsecured Card', bureau_pulled: 'Equifax', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau REPORTED Equifax: 4 of 4 community datapoints unanimous (PA, MI, KY) but all are 2018 or older, so treat this as a lead rather than settled. Call and confirm. Bureau not a single answer (TU vs EQ conflict — see Cashback card note). Choose a category for 3x rewards up to $2,000/quarter, 1x elsewhere, 15.49%-27.49% APR. +25% bonus points with a linked Huntington Platinum Perks checking account.' },
      { name: 'Huntington Voice Credit Card (Lower Rate)', type: 'Unsecured Card', bureau_pulled: 'Equifax', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau REPORTED Equifax: 4 of 4 community datapoints unanimous (PA, MI, KY) but all are 2018 or older, so treat this as a lead rather than settled. Call and confirm. Bureau not a single answer (TU vs EQ conflict). No rewards, but their lowest rate: 13.49%-25.49% APR.' },
      { name: 'Huntington Secured Credit Card', type: 'Secured Card', bureau_pulled: 'Not Verified', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: '$250–$2,500 (deposit sets your limit)', annual_fee: 'None', graduation_potential: 'Yes', graduation_timeline: '7 months', existing_customer_required: 'No', strategy_notes: 'Verified Sep 2026 on huntington.com: the account is reviewed after SEVEN MONTHS for upgrade eligibility to the named Huntington Cashback Credit Card. Deposit from $250 (lower than most bank secured cards) up to $2,500 and that sets your limit. No annual fee, unlimited 1% cash back. Requires a Huntington account, so open the checking first.', verified_date: '2026-09-01'},
    ],
  },

  {
    ...
    verified_date: '2026-07-06',
    products: [
      { name: 'PNC Cash Rewards', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau CONFIRMED Experian: 10 of 10 community datapoints (CreditBoards, Sep 2026) across CA, PA, IL and AL, unanimous, including 2022 and 2023 reports. Still call and confirm before you apply. Bureau varies by state (Experian in NY/FL, Equifax in TX/OH per prior research) — flagged honestly as Not Verified rather than picking one. 4% gas/3% restaurants/2% groceries, $200 bonus ($1k spend/3mo), 13.49%-23.49% APR.' },
      { name: 'PNC Cash Unlimited', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau CONFIRMED Experian: 10 of 10 community datapoints (CreditBoards, Sep 2026) across CA, PA, IL and AL, unanimous, including 2022 and 2023 reports. Still call and confirm before you apply. Bureau varies by state (see Cash Rewards note). Flat 2% cash back, 0% intro APR 15 months on balance transfers, 18.49%-28.49% after.' },
      { name: 'PNC Spend Wise', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau CONFIRMED Experian: 10 of 10 community datapoints (CreditBoards, Sep 2026) across CA, PA, IL and AL, unanimous, including 2022 and 2023 reports. Still call and confirm before you apply. Bureau varies by state (see Cash Rewards note). 0% intro APR 18 months on purchases + balance transfers, 19.49%-27.49% after, includes a purchase-APR reduction program.' },
      { name: 'PNC Secured', type: 'Secured Card', bureau_pulled: 'Not Verified', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: '$300–$2,500 (in $50 increments, at account opening)', annual_fee: 'None', graduation_potential: 'Not Verified', graduation_timeline: 'Not Found', existing_customer_required: 'No', strategy_notes: 'Verified Sep 2026 on pnc.com. Deposit $300 to $2,500 in $50 increments, made at account opening, and it sets your limit. No annual fee. TWO THINGS TO KNOW BEFORE YOU GO: PNC frames this around an in-branch appointment and asks for the deposit as a CASHIER\'S CHECK, so it is not a sit-at-home application like most secured cards. And PNC does NOT publish any conversion to an unsecured card, so do not count on graduating here, ask in the branch.', verified_date: '2026-09-01'},
    ],
  },

  {
    ...
    verified_date: '2026-07-06',
    products: [
      { name: 'Discover it Cash Back', type: 'Unsecured Card', bureau_pulled: 'Varies by state', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau VARIES: 162 community datapoints (CreditBoards, Sep 2026) split Equifax 76, Experian 60, TransUnion 26. Discover genuinely does not use one bureau nationally, so CALL AND ASK which they pull before you apply and plan the lane around their answer. Bureau not re-confirmed this pass. 5% cash back on rotating quarterly categories (activation required) + 1% elsewhere, unlimited Cashback Match at the end of year 1, 0% intro APR 15 months. Official soft-pull preapproval, no credit impact.' },
      { name: 'Discover it Miles', type: 'Unsecured Card', bureau_pulled: 'Varies by state', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau VARIES: 162 community datapoints (CreditBoards, Sep 2026) split Equifax 76, Experian 60, TransUnion 26. Discover genuinely does not use one bureau nationally, so CALL AND ASK which they pull before you apply and plan the lane around their answer. Bureau not re-confirmed this pass. Flat 1.5x miles on every purchase, unlimited Discover Match year 1, 0% intro APR 15 months.' },
      { name: 'Discover it Chrome', type: 'Unsecured Card', bureau_pulled: 'Varies by state', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau VARIES: 162 community datapoints (CreditBoards, Sep 2026) split Equifax 76, Experian 60, TransUnion 26. Discover genuinely does not use one bureau nationally, so CALL AND ASK which they pull before you apply and plan the lane around their answer. Bureau not re-confirmed this pass. 2% cash back on gas + restaurants (first $1,000/quarter combined) + 1% elsewhere, 0% intro APR 15 months.' },
      { name: 'Discover it Student Cash Back', type: 'Unsecured Card', bureau_pulled: 'Varies by state', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau VARIES: 162 community datapoints (CreditBoards, Sep 2026) split Equifax 76, Experian 60, TransUnion 26. Discover genuinely does not use one bureau nationally, so CALL AND ASK which they pull before you apply and plan the lane around their answer. Bureau not re-confirmed this pass. Student version of Cash Back — same 5% rotating categories, 0% intro APR 6 months.' },
      { name: 'Discover it Student Chrome', type: 'Unsecured Card', bureau_pulled: 'Varies by state', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau VARIES: 162 community datapoints (CreditBoards, Sep 2026) split Equifax 76, Experian 60, TransUnion 26. Discover genuinely does not use one bureau nationally, so CALL AND ASK which they pull before you apply and plan the lane around their answer. Bureau not re-confirmed this pass. Student version of Chrome, 0% intro APR 6 months.' },
      { name: 'NHL Discover it', type: 'Unsecured Card', bureau_pulled: 'Varies by state', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau VARIES: 162 community datapoints (CreditBoards, Sep 2026) split Equifax 76, Experian 60, TransUnion 26. Discover genuinely does not use one bureau nationally, so CALL AND ASK which they pull before you apply and plan the lane around their answer. Bureau not re-confirmed this pass. Team-branded version of Cash Back, same terms, cards for all 32 NHL teams.' },
    ],
  },
...

  {
    ...
    verified_date: '2026-07-05',
    products: [
      { name: 'Upstart Personal Loan', type: 'Personal Loan', bureau_pulled: 'TransUnion', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', preapproval_available: 'Yes', strategy_notes: 'Bureau REPORTED TransUnion: 3 of 3 community datapoints (AL, NY, NH), most recent 2022. Thin sample, so confirm. Note their rate check is a soft pull, so you can test before any hard inquiry. Verified Sep 2026 on upstart.com. No minimum credit score is published, and that is the point: Upstart states its model looks at MORE than your credit score, weighing income and employment history too, and they market to people with insufficient credit history. Loans $1,000 to $75,000, APR 6.3% to 35.99% at time of check. CHECKING YOUR RATE IS A SOFT PULL and does not affect your score, so a thin-file or lower-score member can find out for free instead of guessing.', verified_date: '2026-09-01'},
    ],
  },

  {
    ...
    verified_date: '2026-07-05',
    products: [
      { name: 'SoFi Personal Loan', type: 'Personal Loan', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'None (no origination/late/prepayment fees)', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau CONFIRMED Experian: 11 of 11 community datapoints unanimous (CreditBoards, Sep 2026), most recent 2023. Still call and confirm before you apply. Bureau not yet verified. OFFICIAL soft-pull rate check confirmed repeatedly, no credit impact; hard pull only if you continue the application. $5,000-$100,000, 6.99%-35.49% fixed APR, same-day funding possible.' },
      { name: 'SoFi Credit Card', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'Not Verified', inquiry_reuse_eligible: 'Not Verified', preapproval_available: 'Not Found', minimum_credit_score: null, deposit_amount: 'N/A', annual_fee: 'Not Verified', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Bureau CONFIRMED Experian: 11 of 11 community datapoints unanimous (CreditBoards, Sep 2026), most recent 2023. Still call and confirm before you apply. Bureau not yet verified. Community report: hard pull occurs only upon approval; a declined application results in only a soft pull.' },
    ],
  },
...

  {
    ...
    products: [
      ...
      { name: 'Platinum Secured Credit Card', type: 'Secured Card', bureau_pulled: 'All 3', reports_to: 'All 3', inquiry_reuse_eligible: 'No', preapproval_available: 'Yes', minimum_credit_score: null, deposit_amount: '$49, $99, or $200 (deposit more to raise your line, up to $1,000)', annual_fee: 'None', graduation_potential: 'Yes', graduation_timeline: '6 months', existing_customer_required: 'No', verified_date: '2026-09-01', strategy_notes: 'Re-verified Sep 2026 on capitalone.com: "considered for a credit line increase in as little as six months" with responsible use, and Capital One\'s own upgrade page confirms review for a move to an unsecured card. The $49 and $99 deposit tiers are not offered to everyone, they depend on your profile. 28.99% variable APR at time of check, no annual fee. No-impact prequalification available, always use it before the hard pull.' },
    ],
  },
...

  {
    ...
    verified_date: '2026-07-04',
    products: [
      { name: 'opensky Launch Secured Visa', type: 'Secured Card', bureau_pulled: 'None', reports_to: 'All 3', inquiry_reuse_eligible: 'No', preapproval_available: 'No', minimum_credit_score: null, deposit_amount: '$150 minimum (sets your limit)', annual_fee: '$2/month', graduation_potential: 'Yes', graduation_timeline: '6 months (automatic upgrade review)', existing_customer_required: 'No', verified_date: '2026-09-01', strategy_notes: 'LOWEST deposit in our database at $150, and NO credit check at all, so opening it does not touch your reports. Fee is $2/month rather than annual. Reports to all 3 bureaus. Verified Sep 2026 on openskycc.com: after 6 months OpenSky automatically reviews the account for upgrade to the opensky Gold Unsecured Visa, with no new application and no new deposit.' },
      { name: 'OpenSky Secured Visa', type: 'Secured Card', bureau_pulled: 'None', reports_to: 'All 3', inquiry_reuse_eligible: 'No', preapproval_available: 'No', minimum_credit_score: null, deposit_amount: '$200 minimum (sets your limit)', annual_fee: '$35', graduation_potential: 'Yes', graduation_timeline: '6 months (automatic upgrade review)', existing_customer_required: 'No', verified_date: '2026-09-01', strategy_notes: 'NO credit check at all, so approval does not touch your reports. One of the few true zero-inquiry entry points. Reports to all 3 bureaus. Verified Sep 2026 on openskycc.com: after 6 months OpenSky automatically reviews the account for upgrade to the named opensky Gold Unsecured Visa, no new application and no new deposit required. Note the $35 annual fee, the Plus version at a $300 deposit has none.' },
      { name: 'OpenSky Plus Secured Visa', type: 'Secured Card', bureau_pulled: 'None', reports_to: 'All 3', inquiry_reuse_eligible: 'No', preapproval_available: 'No', minimum_credit_score: null, deposit_amount: '$300 minimum (sets your limit)', annual_fee: 'None', graduation_potential: 'Yes', graduation_timeline: '6 months (automatic upgrade review)', existing_customer_required: 'No', verified_date: '2026-09-01', strategy_notes: 'No annual fee at all, the trade is a $300 deposit instead of $200. Same zero-credit-check approval, same all-3 reporting. Verified Sep 2026 on openskycc.com: 6-month automatic review for upgrade to the opensky Gold Unsecured Visa, no new application or deposit. If you can cover $300, this beats the $35/yr version on cost.' },
    ],
  },
...

  {
    ...
    verified_date: '2026-07-04',
    products: [
      { name: 'Credit Builder Secured Visa', type: 'Secured Card', bureau_pulled: 'None', reports_to: 'All 3', inquiry_reuse_eligible: 'No', preapproval_available: 'No', minimum_credit_score: null, deposit_amount: '$300–$3,000 (equals your limit)', annual_fee: 'None ($5/quarter unless enrolled in eStatements)', graduation_potential: 'Yes', graduation_timeline: 'Upgrade to unsecured with good performance', existing_customer_required: 'No', strategy_notes: 'Verified Sep 2026 on afbank.com: the product page states plainly that it is OPEN TO THE GENERAL PUBLIC, so despite the name you do not need military service. Deposit $300 to $3,000 sets your limit, no annual fee, 25.99% APR at time of check, automatic reporting to all three bureaus. Graduation to an unsecured card is confirmed (\'with improvements to your credit score, graduate to an Unsecured Credit Card\') but Armed Forces Bank does not publish a timeline, so we do not invent one.', verified_date: '2026-09-01'},
    ],
  },
