...
const allInstitutions: InstitutionRow[] = [
...

  {
    ...
    path: 'Capital Access',
    products: [
      { name: 'Chase Freedom Unlimited', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'All 3', inquiry_reuse_eligible: 'Yes', preapproval_available: 'Yes', minimum_credit_score: 670, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Pulls Experian primary. Preapproval via Chase site. 5/24 rule applies. Inquiry reuse within 30 days for multiple Chase cards.' },
      { name: 'Chase Freedom Flex', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'All 3', inquiry_reuse_eligible: 'Yes', preapproval_available: 'Yes', minimum_credit_score: 670, deposit_amount: 'N/A', annual_fee: 'None', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Rotating 5% categories. Pulls Experian. Stack with Freedom Unlimited on same inquiry window. 5/24 rule applies.' },
      { name: 'Chase Sapphire Preferred', type: 'Unsecured Card', bureau_pulled: 'Experian', reports_to: 'All 3', inquiry_reuse_eligible: 'Yes', preapproval_available: 'Yes', minimum_credit_score: 700, deposit_amount: 'N/A', annual_fee: '$95', graduation_potential: 'N/A', graduation_timeline: 'N/A', existing_customer_required: 'No', strategy_notes: 'Premium travel card. Pulls Experian. Apply early in strategy — 5/24 rule locks out once you hit 5 new accounts.' },
    ],
  },
